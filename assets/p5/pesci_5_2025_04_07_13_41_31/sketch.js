...
function setup() {
  ...
  coloreAcqua = color('rgba(25,108,151,0.3)'); // Blu acqua
...
class Pianta {
  ...
  update() {
        let massimo = width/10;
        if(this.size < massimo){
          this.size += 2;
        } else if (this.size > massimo){
          this.size = massimo;
        }
  }
